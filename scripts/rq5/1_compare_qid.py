...
def run_matching_analysis():
    ...
    try:
        # Caricamento con gestione separatori
    ...
    # --- 2. FUNZIONE DI ESTRAZIONE E PULIZIA ---
    ...
    def extract_qids(df, column):
        ...
        # Pulizia rigorosa per il confronto
    ...
    if matches_unesco:
        ...
        print("ℹ️ Nessun match UNESCO trovato, nessun CSV generato.")

    # Salvataggio Match UNESCO-L4R
    if matches_l4r:
        ...
        print("ℹ️ Nessun match L4R trovato, nessun CSV generato.")
