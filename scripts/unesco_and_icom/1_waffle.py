...
<body>
  <div class="viz-wrapper">
    ...
    <h1 style="font-size:26px; font-weight:700; margin-bottom:8px;">
      What <span style="color:#F1C40F;">UNESCO</span> Lists vs. 
      What the War <span style="color:#2471A3;">ACTUALLY</span> Hits 
    </h1>

    <p style="font-size:15px; margin-top:0; margin-bottom:25px; color:#444;">
Protected heritage sites and institutionally unprotected cultural entities affected by conflict in Ukraine    </p>
